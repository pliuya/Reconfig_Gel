...
// phi = 0.3, PHIIni = 0.1875, phi = 0.2, PHIIni = 0.125; phi = 0.1, PHIIni = 0.0625; (T=22)
// phi = 0.3, PHIIni = 0.566, phi = 0.2, PHIIni = 0.377; phi = 0.1, PHIIni = 0.189; (T=36)
...
double deltaX = 1.0;
//double PHIIni = 0.0503;
double PHIIni = 0.1875;//this value is useless since PHIIni read from conf. temp
double phi0 = 0.1286;
